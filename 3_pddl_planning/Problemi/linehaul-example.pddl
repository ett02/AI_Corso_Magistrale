; In questo esempio sono presenti 4 posizioni,
; 2 camion, uno refrigerato ed uno no e la quantità
; "massima" è 40, si ricorda che le quantità 
; rappresetano un meccanismo di simulazione dei 
; numeri interi
